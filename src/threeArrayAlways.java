...
//				System.out.println("Array3 size: " + array3.size());
        ...
        public static void converge() throws Exception{
			...
			data1 = wekaFunctions.trim(data1, classIndex);
                        ...
                        data3 = wekaFunctions.trim(data3, classIndex);
...
//                                }
			...
			if ( array1.equals(array1Backup) && array2.equals(array2Backup) && array3.equals(array3Backup)){
				double accuracy = data1.numInstances()*Array1Accuracy/230600 + data2.numInstances()*Array2Accuracy/230600 + data3.numInstances()*Array3Accuracy/230600;
				System.out.println("*****************************************************************************");
